...
if device == 'mps':
    train_root = "/Users/mac/Downloads/SAMED"
else:
    train_root = "/home/code/SAMED"
...
parser.add_argument('--modelname', default='SAMED', type=str,
                        help='type of model, e.g., SAM.')
parser.add_argument('-encoder_input_size', type=int, default=256,
                        help='the image size of the encoder input, 256 in SAMED')
parser.add_argument('-low_image_size', type=int, default=128,
                        help='the image embedding size, 128 SAMED')
parser.add_argument('--task', default='BSDS', help='task or dataset name')  # TN3K/US30K
...
parser.add_argument('--sam_ckpt', type=str,
                        default='D:/ywy/3.Dada_Code/Codes/Official/0.checkpoint/sam_vit_b_01ec64.pth',
...
def iter(mask, len_epoch, save_dir, bi_dict, cv_mask,threshold=0.8):
